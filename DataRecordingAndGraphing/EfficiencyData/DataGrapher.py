...
tempPlot.plot(times[0], numData[0][0], c = "#BDD9BF", linewidth = 2.0)
tempPlot.plot(times[1], numData[1][0], c = "#A997DF", linewidth = 2.0)
tempPlot.plot(times[2], numData[2][0], c = "#E5323B", linewidth = 2.0)
...
signalPlot.plot(times[0], [numData[0][1][i] * numData[0][2][i] for i in range(len(numData[0][0]))], c = "#BDD9BF", linewidth = 2.0)
signalPlot.plot(times[1], [numData[1][1][i] * numData[1][2][i] for i in range(len(numData[1][0]))], c = "#A997DF", linewidth = 2.0)
signalPlot.plot(times[2], [numData[2][1][i] * numData[2][2][i] for i in range(len(numData[2][0]))], c = "#E5323B", linewidth = 2.0)
signalPlot.plot(times[3], [numData[3][1][i] * numData[3][2][i] for i in range(len(numData[3][0]))], c = "#2E4052", linewidth = 2.0)
