...
tempPlot.plot(times[0], numData[0][0], c = "#4E004D", linewidth = 2.0)
tempPlot.plot(times[1], numData[1][0], c = "#0049AE", linewidth = 2.0)
tempPlot.plot(times[2], numData[2][0], c = "#11C155", linewidth = 2.0)
tempPlot.plot(times[3], numData[3][0], c = "#FF972E", linewidth = 2.0)
...
signalPlot.plot(times[0], [numData[0][1][i] * numData[0][2][i] for i in range(len(numData[0][0]))], c = "#4E004D", linewidth = 2.0)
signalPlot.plot(times[1], [numData[1][1][i] * numData[1][2][i] for i in range(len(numData[1][0]))], c = "#0049AE", linewidth = 2.0)
signalPlot.plot(times[2], [numData[2][1][i] * numData[2][2][i] for i in range(len(numData[2][0]))], c = "#11C155", linewidth = 2.0)
signalPlot.plot(times[3], [numData[3][1][i] * numData[3][2][i] for i in range(len(numData[3][0]))], c = "#FF972E", linewidth = 2.0)
